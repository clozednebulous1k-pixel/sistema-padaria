...
<html>
  <head>
    ...
    <style>
      ...
      h1 { color: #333; border-bottom: 2px solid #550701; padding-bottom: 4px; margin-bottom: 8px; font-size: 14px; }
      .info { margin: 6px 0; padding: 8px; background-color: #f9f9f9; border-left: 4px solid #f3b125; font-size: 10px; }
      .info p { margin: 2px 0; }
      ...
      .total { margin-top: 8px; padding: 8px; background-color: #550701; color: white; text-align: center; font-size: 12px; font-weight: bold; }
    </style>
  </head>
  <body>
