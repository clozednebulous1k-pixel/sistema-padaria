...
import { produtoApi, massaApi, recheioApi } from '@/lib/api'
...
export default function NovoProdutoPage() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<FormData>({ defaultValues: { tipo_massa: '', recheio: '' } })
  ...
  const onSubmit = async (data: FormData) => {
    registrarClique('Salvar', 'Produtos', 'Novo Produto', 'produto', undefined, `Produto: ${data.nome}`)
