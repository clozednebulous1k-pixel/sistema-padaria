...
COMMENT ON TABLE usuarios_padaria IS 'Tabela de usuários do sistema';
...
COMMENT ON COLUMN motoristas_padaria.periodo IS 'Período de trabalho do motorista: matutino ou noturno';
COMMENT ON COLUMN usuarios_padaria.ativo IS 'Indica se o usuário está ativo';