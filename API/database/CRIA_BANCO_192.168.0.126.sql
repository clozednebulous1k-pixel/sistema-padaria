...
-- ============================================
-- CRIAR BANCO - Padaria Belfort
-- Banco: db_padaria_belfort
-- ============================================
-- Execute como postgres (administrador)
-- ============================================

-- Etapa 1: Criar banco e usuário (conecte em postgres ou template1)
CREATE DATABASE db_padaria_belfort;

-- Crie o usuário no PostgreSQL e defina a senha conforme seu ambiente.
...
-- ALTER DATABASE db_padaria_belfort OWNER TO padaria_app;
-- (Substitua padaria_app e a senha conforme sua política de segurança.)

-- ============================================
-- A PARTIR DAQUI: conecte no banco db_padaria_belfort
-- No psql: \c db_padaria_belfort
-- No pgAdmin: selecione db_padaria_belfort e execute o restante
-- ============================================

-- Conceder permissões no schema (ajuste o nome do usuário se necessário)
